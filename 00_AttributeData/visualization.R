...
#Figure X? Enteritis Score by Hatchery as a function of parasite load
metadata$ID <- rownames(metadata)
melted_scores <- melt(metadata,id.vars = c("ID","hatchery","enteritis"), measure.vars = c("es", "cshasta"))
